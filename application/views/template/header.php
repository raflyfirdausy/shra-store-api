    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link"><?= ($this->userData->level_admin == LEVEL_SUPER_ADMIN) ? "<label class='labelUser'>Superadmin</label>" : "<label class='labelUser'>Admin - </label> " . $this->userData->toko->nama_toko ?></a>
                </li>
            </ul>
